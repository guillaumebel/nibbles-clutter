var bkg_top = new Clutter.Texture.from_file('/usr'+"/share/pixmaps/lightsoff/lcd-front.svg");
var bkg = new Clutter.Texture.from_file('/usr'+"/share/pixmaps/lightsoff/lcd-back.svg");
...
Score = new GType({
	...
	init: function(klass)
	{
		...
		var off_svg = new Clutter.Texture.from_file('/usr'+"/share/pixmaps/lightsoff/lcd-off.svg");
		...
		for(var i = 0; i <= 9; i++)
		{
			num_textures[i] = new Clutter.Texture.from_file('/usr'+"/share/pixmaps/lightsoff/"+i+".svg");
